...
export default function CadastrarAluno() {
  ...
  const cadastrarDados = () => {
    ...
    if (!nome || !dataNascimento || !cpf || !entrada || !telefone) {
      Alert.alert(
        ...
        [
          {
            text: 'OK',
            onPress: () => console.log('Alertando sobre campos obrigatórios'),
          },
        ],
        { cancelable: false }
      );
    ...
    const novoCadastro = {
      nome,
      nascimento: dataNascimento,  // Corrigido para 'nascimento'
      cpf,
      email,
      sexo,
      entrada,
    ...
    Axios.post("http://192.168.0.118:3001/item", novoCadastro)
      .then(response => {
    ...
    // Adiciona o novo cadastro à lista de alunos cadastrados
    setAlunosCadastrados([...alunosCadastrados, novoCadastro]);
    Alert.alert(
      'Sucesso',
      'Aluno cadastrado com sucesso!',
      [
